...
for i in range(len(fones)):
    if check_duplicado(fones[i]) and sum_of_digits(fones[i]) and check_last_number(fones[i]):
        validos += 1
print("Total de números validos é: ", validos)
